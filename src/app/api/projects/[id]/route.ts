    ...
    const project = await Project.findByIdAndUpdate(
      id,
      {
        $set: {
          ...
          contractId: updateData.contractId ? String(updateData.contractId).trim() : null,
          contractName: updateData.contractName ? String(updateData.contractName).trim() : null,
          appropriation: updateData.appropriation ? String(updateData.appropriation).trim() : null,
          location: updateData.location ? String(updateData.location).trim() : null,
